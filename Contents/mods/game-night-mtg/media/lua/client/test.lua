...
Badlands;; Land - Swamp Mountain;; ({T}: Add {B} or {R}.);;@
Taiga;; Land - Mountain Forest;; ({T}: Add {R} or {G}.);;@
Savannah;; Land - Forest Plains;; ({T}: Add {G} or {W}.);;@
Scrubland;; Land - Plains Swamp;; ({T}: Add {W} or {B}.);;@
Volcanic Island;; Land - Island Mountain;; ({T}: Add {U} or {R}.);;@
