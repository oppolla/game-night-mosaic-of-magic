...
local mtgAlphaWhiteLand = {
    "MTG Alpha White Land 1",
    "MTG Alpha White Land 2",
}
local mtgAlphaBlackLand = {
    "MTG Alpha Black Land 1",
    "MTG Alpha Black Land 2",
}
local mtgAlphaGreenLand = {
    "MTG Alpha Green Land 1",
    "MTG Alpha Green Land 2",
}
local mtgAlphaBlueLand = {
    "MTG Alpha Blue Land 1",
    "MTG Alpha Blue Land 2",
}
local mtgAlphaRedLand = {
    "MTG Alpha Red Land 1",
    "MTG Alpha Red Land 2",
}
local mtgAlphaRareLand = {
    "MTG Alpha White Black Land 1",
    "MTG Alpha Blue White Land 1",
    "MTG Alpha Black Green Land 1",
    "MTG Alpha Red Black Land 1",
...
local deckArchetypesList = {
    ...
    local deckIntermediate = {}

-- Iterate over the larger table
for _, value in ipairs(largerTable) do
    -- Check if the current value is one of the specific strings
    if table.contains(specificStrings, value) then
        -- Insert the value into the subset table
        table.insert(subsetTable, value)
    end
end
...
for _, value in ipairs(mtgAlpha) do
    -- Check if the current value is one of the specific strings
    if table.contains(specificStrings, value) then
        -- Insert the value into the subset table
        table.insert(subsetTable, value)
